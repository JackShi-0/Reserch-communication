...
totalbit = mod_order *Nscd * Npacket;
...
iDFnT_input = symbol;
ofdm_out = Phi_Nchirp'*iDFnT_input;
...
%     h_i = [h(1:P_len,i);zeros(Nchirp+Ngd-P_len,1)];
    H_i = fft(h_i); %放到频域上
...
%     EQ_out_u(:,i) = Phi_Nchirp * x_zf;%解调数据
...
xlim([0,40]);
toc
% save 0615-ocdm-multipath-sigma-chanknown-1 BER_u
% save 0615-ocdm-Doppler-sigma-chanknown BER_u
% save 0615-ocdm-Doppler-sigma-chanknown-2 BER_u
% save 0616-ocdm-Doppler-sigma-chanknown-1e-3 BER_u
% save 0617-ocdm-mp-2sigma-channorm BER_u
% save 0617-ocdm-Doppler-sigma-chanknown-5e-4 BER_u